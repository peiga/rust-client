#include "run_on_hit.hpp"

#include "../../../engine/engine.hpp"
#include "../../../renderer/menu/config/config.hpp"

void modules::weapon::run_on_hit::callback()
{
	...
	if (std::get< bool >(menu::config::config_map[features::enable_run_on_hit]))
	{
		...
		{
			driver.write<bool>(held_item.get_base_projectile().instance + engine::offsets::base_melee::block_sprint_on_attack, false);
		}
	}
}